  ...
  "node_modules/@heyputer/kv.js/XMap.js"(exports2, module2) {
    ...
    var XMap = class {
      ...
      constructor(entries = []) {
        ...
        __privateSet(this, _pool, [new Map(entries)]);
      }
      /**
       ...
       */
      get size() {
        return __privateGet(this, _pool).reduce((sum, map) => sum + map.size, 0);
      }
      /**
       * Removes all key-value pairs from the XMap.
       */
      clear() {
        __privateSet(this, _pool, [/* @__PURE__ */ new Map()]);
      }
      /**
       ...
       */
      delete(key) {
        return __privateGet(this, _pool).some((map) => map.delete(key));
      }
      /**
       ...
       */
      get(key) {
        for (const map of __privateGet(this, _pool)) {
          if (map.has(key)) {
            return map.get(key);
          }
        }
       ...
       */
      has(key) {
        return __privateGet(this, _pool).some((map) => map.has(key));
      }
      /**
       ...
       */
      set(key, value) {
        let targetMap = __privateGet(this, _pool)[0];
        for (const map of __privateGet(this, _pool)) {
          if (map.has(key)) {
            targetMap = map;
            break;
        ...
        if (!targetMap.has(key) && targetMap.size >= 8388608) {
          __privateGet(this, _pool).unshift(/* @__PURE__ */ new Map());
          targetMap = __privateGet(this, _pool)[0];
        }
...
// node_modules/@heyputer/puter.js/src/modules/UsageLimitDialog.js
...
// node_modules/@heyputer/puter.js/src/modules/EmailConfirmationDialog.js
...
function initXhr(endpoint, APIOrigin, authToken, method = "post", contentType = "text/plain;actually=json", responseType = void 0) {
  ...
  if ((_b = (_a = globalThis.puter) == null ? void 0 : _a.apiCallLogger) == null ? void 0 : _b.isEnabled()) {
    xhr._puterRequestId = {
      method,
      service: "xhr",
...
async function handle_resp(success_cb, error_cb, resolve_func, reject_func, response) {
  ...
  if (response.status === 401) {
    ...
    if (resp.success === false && ((_a = resp.error) == null ? void 0 : _a.code) === "permission_denied") {
...
function setupXhrEventHandlers(xhr, success_cb, error_cb, resolve_func, reject_func) {
  xhr.addEventListener("load", async function(e2) {
    var _a, _b;
    if (((_b = (_a = globalThis.puter) == null ? void 0 : _a.apiCallLogger) == null ? void 0 : _b.isEnabled()) && this._puterRequestId) {
...
async function driverCall_(options = {}, resolve_func, reject_func, driverInterface, driverName, driverMethod, driverArgs, method, contentType = "text/plain;actually=json", settings = {}) {
  ...
  if (!puter.authToken && puter.env === "web") {
    try {
      ...
      if (requestInfo && ((_d = (_c = globalThis.puter) == null ? void 0 : _c.apiCallLogger) == null ? void 0 : _d.isEnabled())) {
        globalThis.puter.apiCallLogger.logRequest({
          service: "drivers",
  ...
  xhr.onreadystatechange = () => {
      ...
      const Stream = async function* Stream2() {
        ...
        while (!response_complete) {
          ...
          while (lines_received.length > 0) {
            ...
            if (((_a2 = lineObject == null ? void 0 : lineObject.error) == null ? void 0 : _a2.code) === "insufficient_funds" || ((_b2 = lineObject == null ? void 0 : lineObject.metadata) == null ? void 0 : _b2.usage_limited) === true) {
              if (puter.env === "web") {
            ...
            if (((_c2 = lineObject == null ? void 0 : lineObject.error) == null ? void 0 : _c2.code) === "email_must_be_confirmed" && puter.env === "web") {
              showEmailConfirmationDialog(((_d2 = lineObject == null ? void 0 : lineObject.error) == null ? void 0 : _d2.message) || "Email confirmation required. Go to Puter.com to confirm your email address.");
            }
    ...
    if (xhr.readyState === 4) {
      ...
      if (is_stream) {
        signal_stream_update == null ? void 0 : signal_stream_update();
      }
    }
  };
  ...
  xhr.addEventListener("load", async function(response) {
    ...
    if (this._puterDriverRequestInfo && ((_b2 = (_a2 = globalThis.puter) == null ? void 0 : _a2.apiCallLogger) == null ? void 0 : _b2.isEnabled())) {
      globalThis.puter.apiCallLogger.logRequest({
        service: "drivers",
        ...
        result: response.status >= 400 || (resp == null ? void 0 : resp.success) === false ? null : resp,
        error: response.status >= 400 || (resp == null ? void 0 : resp.success) === false ? resp : null
      });
    }
    const isInsufficientFunds = ((_c2 = response.target) == null ? void 0 : _c2.status) === 402 || ((_d2 = resp == null ? void 0 : resp.error) == null ? void 0 : _d2.code) === "insufficient_funds" || ((_e = resp == null ? void 0 : resp.error) == null ? void 0 : _e.status) === 402;
    const isUsageLimited = ((_f = resp == null ? void 0 : resp.metadata) == null ? void 0 : _f.usage_limited) === true;
    ...
    if (((_g = resp == null ? void 0 : resp.error) == null ? void 0 : _g.code) === "email_must_be_confirmed" && puter.env === "web") {
      showEmailConfirmationDialog(((_h = resp == null ? void 0 : resp.error) == null ? void 0 : _h.message) || "Email confirmation required. Go to Puter.com to confirm your email address.");
    }
    if (response.status === 401 || (resp == null ? void 0 : resp.code) === "token_auth_failed") {
      if ((resp == null ? void 0 : resp.code) === "token_auth_failed" && puter.env === "web") {
        try {
      ...
      if (resp.success === false && ((_i = resp.error) == null ? void 0 : _i.code) === "permission_denied") {
  ...
  xhr.send(JSON.stringify({
    interface: driverInterface,
    driver: driverName,
    test_mode: settings == null ? void 0 : settings.test_mode,
    method: driverMethod,
    args: driverArgs,
...
var AI = class {
   ...
   */
  constructor(puter3) {
    __publicField(this, "img2txt", async (...args) => {
      var _a;
      ...
      } else if (((_a = options.source) == null ? void 0 : _a.source) && isBlobLike(options.source.source)) {
      ...
      const toText = (result) => {
        ...
        if (Array.isArray(result.blocks) && result.blocks.length) {
          ...
          for (const block of result.blocks) {
            if (typeof (block == null ? void 0 : block.text) !== "string") continue;
...
`;
        ...
        if (Array.isArray(result.pages) && result.pages.length) {
          const markdown = result.pages.map((page) => ((page == null ? void 0 : page.markdown) || "").trim()).filter(Boolean).join("\n\n");
    ...
    __publicField(this, "txt2speech", async (...args) => {
    ...
    __publicField(this, "speech2speech", async (...args) => {
    ...
    __publicField(this, "speech2txt", async (...args) => {
      const MAX_INPUT_SIZE = 25 * 1024 * 1024;
      if (!args || !args.length) {
        throw { message: "Arguments are required", code: "arguments_required" };
      }
    ...
    __publicField(this, "txt2speech", Object.assign(this.txt2speech, {
      /**
    ...
    __publicField(this, "chat", async (...args) => {
      let requestParams = {};
      let userParams = {};
      let testMode = false;
      let driver = "ai-chat";
      ...
      return await make_driver_method(["messages"], "puter-chat-completion", driver, "complete", {
        ...
        transform: async (result) => {
          result.toString = () => {
            var _a;
            return (_a = result.message) == null ? void 0 : _a.content;
          };
          result.valueOf = () => {
            var _a;
            return (_a = result.message) == null ? void 0 : _a.content;
     ...
     * });
     */
    __publicField(this, "txt2img", async (...args) => {
      let options = {};
      let testMode = false;
      if (!args) {
        throw { message: "Arguments are required", code: "arguments_required" };
    ...
    __publicField(this, "txt2vid", async (...args) => {
      let options = {};
      let testMode = false;
      if (!args) {
        throw { message: "Arguments are required", code: "arguments_required" };
      ...
      return await make_driver_method(["prompt"], "puter-video-generation", videoService, "generate", {
        ...
        transform: async (result) => {
          ...
          const video = ((_a = globalThis.document) == null ? void 0 : _a.createElement("video")) || { setAttribute: () => {
          } };
          video.src = sourceUrl;
          video.controls = true;
  ...
  async listModels(provider) {
    ...
    const tryFetchModels = async () => {
      ...
      const models2 = Array.isArray(data == null ? void 0 : data.models) ? data.models : [];
    ...
    const tryDriverModels = async () => {
      ...
      const result = Array.isArray(models2 == null ? void 0 : models2.result) ? models2.result : [];
  ...
  async listModelProviders() {
    ...
    (models ?? []).forEach((item) => {
      if (item == null ? void 0 : item.provider) providers.add(item.provider);
    });
...
var _Apps_instances, addUserIterationToApp_fn, addUserIterationToApps_fn;
var Apps = class {
  /**
   * Creates a new instance with the given authentication token, API origin, and app ID,
   *
   ...
   */
  constructor(puter3) {
    __privateAdd(this, _Apps_instances);
    __publicField(this, "list", async (...args) => {
      let options = {};
      if (typeof args[0] === "object" && args[0] !== null) {
        options.params = args[0];
      }
      options.predicate = ["user-can-edit"];
      return __privateMethod(this, _Apps_instances, addUserIterationToApps_fn).call(this, await make_driver_method(["uid"], "puter-apps", "es:app", "select").call(this, options));
    });
    __publicField(this, "create", async (...args) => {
      let options = {};
      if (typeof args[0] === "string") {
        let indexURL = args[1];
      ...
      return __privateMethod(this, _Apps_instances, addUserIterationToApp_fn).call(this, await make_driver_method(["object"], "puter-apps", "es:app", "create").call(this, options));
    });
    __publicField(this, "update", async (...args) => {
      let options = {};
      ...
      return __privateMethod(this, _Apps_instances, addUserIterationToApp_fn).call(this, await make_driver_method(["object"], "puter-apps", "es:app", "update").call(this, options));
    });
    __publicField(this, "get", async (...args) => {
      let options = {};
      if (Array.isArray(args) && typeof args[0] === "string") {
      ...
      return __privateMethod(this, _Apps_instances, addUserIterationToApp_fn).call(this, await make_driver_method(["uid"], "puter-apps", "es:app", "read").call(this, options));
    });
    __publicField(this, "delete", async (...args) => {
      let options = {};
      if (Array.isArray(args) && typeof args[0] === "string") {
        options = { id: { name: args[0] } };
      }
    ...
    __publicField(this, "checkName", async (name) => {
    ...
    __publicField(this, "getDeveloperProfile", function(...args) {
      let options;
      if (typeof args[0] === "object" && args[0] !== null) {
        options = args[0];
      } else {
...
_Apps_instances = new WeakSet();
addUserIterationToApp_fn = function(app) {
...
addUserIterationToApps_fn = function(apps) {
  apps.forEach((app) => {
    __privateMethod(this, _Apps_instances, addUserIterationToApp_fn).call(this, app);
  });
  return apps;
};
...
var Auth = class {
  ...
  constructor(puter3) {
    ...
    __privateAdd(this, _messageID, 1);
    __publicField(this, "signIn", (options) => {
      options = options || {};
      return new Promise((resolve, reject) => {
        let msg_id = __privateWrapper(this, _messageID)._++;
        let w2 = 600;
        let h2 = 700;
        let title = "Puter";
    ...
    __publicField(this, "getUser", function(...args) {
      let options;
      if (typeof args[0] === "object" && args[0] !== null) {
        options = args[0];
      } else {
  ...
  async whoami() {
    ...
    try {
      ...
      if ((_d = (_c = globalThis.puter) == null ? void 0 : _c.apiCallLogger) == null ? void 0 : _d.isEnabled()) {
        globalThis.puter.apiCallLogger.logRequest({
          service: "auth",
          operation: "whoami",
          params: {},
...
var FetchDriverCallBackend = class {
  ...
  async call({ driver, method_name, parameters }) {
    ...
    try {
      ...
      if ((_f = (_e = globalThis.puter) == null ? void 0 : _e.apiCallLogger) == null ? void 0 : _f.isEnabled()) {
        globalThis.puter.apiCallLogger.logRequest({
          service: "drivers",
          operation: `${driver.iface_name}::${method_name}`,
          params: { interface: driver.iface_name, driver: driver.service_name || driver.iface_name, method: method_name, args: parameters },
...
__publicField(FetchDriverCallBackend, "response_handlers", {
...
var FSItem = class {
  constructor(options) {
    __publicField(this, "write", async function(data) {
    ...
    __publicField(this, "watch", function(callback) {
    });
    __publicField(this, "open", function(callback) {
    });
    // Set wallpaper
    __publicField(this, "setAsWallpaper", function(options, callback) {
    });
    __publicField(this, "rename", function(new_name) {
      return puter.fs.rename(this.uid, new_name);
    });
    __publicField(this, "move", function(dest_path, overwrite = false, new_name) {
      return puter.fs.move(this.path, dest_path, overwrite, new_name);
    });
    __publicField(this, "copy", function(destination_directory, auto_rename = false, overwrite = false) {
    ...
    __publicField(this, "versions", async function() {
    });
    __publicField(this, "trash", function() {
    });
    __publicField(this, "mkdir", async function(name, auto_rename = false) {
      if (!this.isDirectory) {
        throw new Error("mkdir() can only be called on a directory");
      }
      return puter.fs.mkdir(path_default.join(this.path, name));
    });
    __publicField(this, "metadata", async function() {
    });
    __publicField(this, "readdir", async function() {
      if (!this.isDirectory) {
        throw new Error("readdir() can only be called on a directory");
      }
      return puter.fs.readdir(this.path);
    });
    __publicField(this, "read", async function() {
...
var copy = function(...args) {
  ...
  if (typeof args[0] === "object" && args[0] !== null) {
    ...
    options = {
      source: args[0],
      destination: args[1],
      overwrite: (_a = args[2]) == null ? void 0 : _a.overwrite,
      new_name: ((_b = args[2]) == null ? void 0 : _b.newName) || ((_c = args[2]) == null ? void 0 : _c.new_name),
      create_missing_parents: ((_d = args[2]) == null ? void 0 : _d.createMissingParents) || ((_e = args[2]) == null ? void 0 : _e.create_missing_parents),
      new_metadata: ((_f = args[2]) == null ? void 0 : _f.newMetadata) || ((_g = args[2]) == null ? void 0 : _g.new_metadata),
      original_client_socket_id: ((_h = args[2]) == null ? void 0 : _h.excludeSocketID) || ((_i = args[2]) == null ? void 0 : _i.original_client_socket_id),
      success: args[3],
      error: args[4]
      // Add more if needed...
    };
...
var deleteFSEntry = async function(...args) {
  ...
  if (typeof args[0] === "object" && args[0] !== null) {
    ...
    options = {
      paths: args[0],
      recursive: ((_a = args[1]) == null ? void 0 : _a.recursive) ?? true,
      descendantsOnly: ((_b = args[1]) == null ? void 0 : _b.descendantsOnly) ?? false
    };
  }
...
// node_modules/@heyputer/puter.js/src/modules/FileSystem/operations/readdirSubdomains.js
...
// node_modules/@heyputer/puter.js/src/modules/FileSystem/operations/revokeReadUrl.js
  ...
  return new Promise(async (resolve, reject) => {
    ...
    for (let i2 = 0; i2 < entries.length; i2++) {
      ...
      if (entries[i2].isDirectory) {
        ...
        let [dirLevel, fileName] = [fileItem == null ? void 0 : fileItem.slice(0, fileItem == null ? void 0 : fileItem.lastIndexOf("/")), fileItem == null ? void 0 : fileItem.slice((fileItem == null ? void 0 : fileItem.lastIndexOf("/")) + 1)];
      ...
      if (xhr.readyState === 4) {
        ...
        if (xhr.status >= 400 && xhr.status < 600 || options.strict && xhr.status === 218) {
          ...
          if (options.strict && xhr.status === 218) {
            ...
            for (let i2 = 0; i2 < ((_a = resp.results) == null ? void 0 : _a.length); i2++) {
...
var PuterJSFileSystemModule = class {
   ...
   */
  constructor(puter3) {
    __publicField(this, "space", space_default);
    __publicField(this, "mkdir", mkdir_default);
    __publicField(this, "copy", copy_default);
    __publicField(this, "rename", rename_default);
    __publicField(this, "upload", upload_default);
    __publicField(this, "read", read_default);
    // Why is this called deleteFSEntry instead of just delete? because delete is
    // a reserved keyword in javascript.
    __publicField(this, "delete", deleteFSEntry_default);
    __publicField(this, "move", move_default);
    __publicField(this, "write", write_default);
    __publicField(this, "sign", sign_default);
    __publicField(this, "symlink", symlink_default);
    __publicField(this, "getReadURL", getReadUrl_default);
    __publicField(this, "revokeReadURL", revokeReadUrl_default);
    __publicField(this, "readdir", readdir_default);
    __publicField(this, "readdirSubdomains", readdirSubdomains_default);
    __publicField(this, "stat", stat_default);
    __publicField(this, "FSItem", FSItem_default);
    this.puter = puter3;
    this.authToken = puter3.authToken;
    this.APIOrigin = puter3.APIOrigin;
    this.appID = puter3.appID;
...
var KV = class {
   ...
   */
  constructor(puter3) {
    __publicField(this, "MAX_KEY_SIZE", 1024);
    __publicField(this, "MAX_VALUE_SIZE", 399 * 1024);
    /**
     ...
     */
    /** @type {SetFunction} */
    __publicField(this, "set", make_driver_method(["key", "value", "expireAt"], "puter-kvstore", void 0, "set", {
      /**
       *
       * @param {object} args
    ...
    __publicField(this, "get_", make_driver_method(["key"], "puter-kvstore", void 0, "get", {
      preprocess: (args) => {
        if (args.key.length > this.MAX_KEY_SIZE) {
          throw { message: `Key size cannot be larger than ${this.MAX_KEY_SIZE}`, code: "key_too_large" };
        }
    ...
    __publicField(this, "incr", async (...args) => {
      let options = {};
      if (!args || args.length === 0) {
        throw { message: "Arguments are required", code: "arguments_required" };
      }
    ...
    __publicField(this, "decr", async (...args) => {
      let options = {};
      if (!args || args.length === 0) {
        throw { message: "Arguments are required", code: "arguments_required" };
      }
    ...
    __publicField(this, "add", async (...args) => {
      let options = {};
      if (!args || args.length === 0) {
        throw { message: "Arguments are required", code: "arguments_required" };
      }
    ...
    __publicField(this, "remove", async (...args) => {
    ...
    __publicField(this, "update", make_driver_method(["key", "pathAndValueMap", "ttl"], "puter-kvstore", void 0, "update", {
      preprocess: (args) => {
        if (args.key === void 0 || args.key === null) {
          throw { message: "Key cannot be undefined", code: "key_undefined" };
        }
     ...
     * @returns
     */
    __publicField(this, "expire", async (key, ttl) => {
      let options = {};
      options.key = key;
      options.ttl = ttl;
      if (options.key.length > this.MAX_KEY_SIZE) {
     ...
     * @returns
     */
    __publicField(this, "expireAt", async (key, timestamp) => {
      let options = {};
      options.key = key;
    ...
    __publicField(this, "del", make_driver_method(["key"], "puter-kvstore", void 0, "del", {
      preprocess: (args) => {
        if (args.key.length > this.MAX_KEY_SIZE) {
          throw { message: `Key size cannot be larger than ${this.MAX_KEY_SIZE}`, code: "key_too_large" };
        }
    ...
    __publicField(this, "flush", make_driver_method([], "puter-kvstore", void 0, "flush"));
    // clear is an alias for flush
    __publicField(this, "clear", this.flush);
    this.puter = puter3;
    this.authToken = puter3.authToken;
    this.APIOrigin = puter3.APIOrigin;
    this.appID = puter3.appID;
    ...
    (async () => {
      ...
      if (!Array.isArray(arr_values == null ? void 0 : arr_values.result)) {
...
var _eventNames, _eventListeners;
var EventListener = class {
  constructor(eventNames) {
    // Array of all supported event names.
    __privateAdd(this, _eventNames);
    // Map of eventName -> array of listeners
    __privateAdd(this, _eventListeners);
    __privateSet(this, _eventNames, eventNames);
    __privateSet(this, _eventListeners, (() => {
      const map = /* @__PURE__ */ new Map();
      for (let eventName of __privateGet(this, _eventNames)) {
        map[eventName] = [];
      }
      return map;
    })());
  ...
  emit(eventName, data) {
    if (!__privateGet(this, _eventNames).includes(eventName)) {
      console.error(`Event name '${eventName}' not supported`);
      return;
    }
    __privateGet(this, _eventListeners)[eventName].forEach((listener) => {
      listener(data);
    });
  }
  on(eventName, callback) {
    ...
    __privateGet(this, _eventListeners)[eventName].push(callback);
    return this;
  }
  off(eventName, callback) {
    ...
    const listeners = __privateGet(this, _eventListeners)[eventName];
...
var PWispHandler = class {
  constructor(wispURL, puterAuth) {
    ...
    __publicField(this, "_nextStreamID", 1);
    __publicField(this, "_bufferMax");
        ...
        start(controller) {
          ...
          socket.on("data", (data) => {
            ...
            if (responseHead.indexOf("\r\n\r\n") !== -1) {
              ...
              if ((_b2 = (_a2 = globalThis.puter) == null ? void 0 : _a2.apiCallLogger) == null ? void 0 : _b2.isEnabled()) {
                globalThis.puter.apiCallLogger.logRequest({
                  service: "network",
                  operation: "pFetch",
                  params: { url: reqObj2.url, method: reqObj2.method },
...
var OS = class {
   ...
   */
  constructor(puter3) {
    __publicField(this, "user", function(...args) {
      let options;
      if (typeof args[0] === "object" && args[0] !== null) {
        options = args[0];
      } else {
    ...
    __publicField(this, "version", function(...args) {
      let options;
      if (typeof args[0] === "object" && args[0] !== null) {
        options = args[0];
      } else {
...
var _Perms_instances, requestAppRootDir_fn;
var Perms = class {
  constructor(puter3) {
    __privateAdd(this, _Perms_instances);
    this.puter = puter3;
    this.authToken = puter3.authToken;
    this.APIOrigin = puter3.APIOrigin;
  }
  ...
  async requestReadAppRootDir(app_uid) {
    return await __privateMethod(this, _Perms_instances, requestAppRootDir_fn).call(this, "read", app_uid);
  }
  /**
  ...
  async requestWriteAppRootDir(app_uid) {
    return await __privateMethod(this, _Perms_instances, requestAppRootDir_fn).call(this, "write", app_uid);
  }
  /**
...
_Perms_instances = new WeakSet();
requestAppRootDir_fn = async function(access, app_uid) {
...
var PuterDialog = class extends (globalThis.HTMLElement || Object) {
  constructor(resolve, reject) {
     ...
     */
    __publicField(this, "isUsingFileProtocol", () => {
      return window.location.protocol === "file:";
    });
    __privateAdd(this, _messageID2);
    // Optional: Handle dialog cancellation as rejection
    __publicField(this, "cancelListener", () => {
      this.close();
    ...
    __privateSet(this, _messageID2, this.constructor.messageID++);
  ...
  connectedCallback() {
    var _a, _b, _c;
    (_a = this.shadowRoot.querySelector("#launch-auth-popup")) == null ? void 0 : _a.addEventListener("click", () => {
      let w2 = 600;
      let h2 = 700;
      let title = "Puter";
      var left = screen.width / 2 - w2 / 2;
      var top = screen.height / 2 - h2 / 2;
      window.open(
        `${puter.defaultGUIOrigin}/?embedded_in_popup=true&request_auth=true&msg_id=${__privateGet(this, _messageID2)}${window.crossOriginIsolated ? "&cross_origin_isolated=true" : ""}`,
        title,
        `toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=no, resizable=no, copyhistory=no, width=${w2}, height=${h2}, top=${top}, left=${left}`
      );
    });
    window.addEventListener("message", this.messageListener);
    (_b = this.shadowRoot.querySelector("#launch-auth-popup-cancel")) == null ? void 0 : _b.addEventListener("click", this.cancelListener);
    (_c = this.shadowRoot.querySelector(".close-btn")) == null ? void 0 : _c.addEventListener("click", this.cancelListener);
  }
  open() {
...
// collisions.
__publicField(PuterDialog, "messageID", Math.floor(Number.MAX_SAFE_INTEGER / 2));
...
var _puterOrigin, _isOpen, _usesSDK;
var _AppConnection = class _AppConnection extends EventListener {
  constructor(puter3, { target, usesSDK, messageTarget, appInstanceID }) {
    ...
    __privateAdd(this, _puterOrigin, "*");
  ...
  get usesSDK() {
    return __privateGet(this, _usesSDK);
  }
  ...
  postMessage(message) {
    ...
    this.messageTarget.postMessage({
      ...
      targetAppOrigin: "*",
      contents: message
    }, __privateGet(this, _puterOrigin));
  }
...
_puterOrigin = new WeakMap();
_isOpen = new WeakMap();
_usesSDK = new WeakMap();
var AppConnection = _AppConnection;
var _messageID3, _parentAppConnection, _callbackFunctions, _onWindowClose, _onItemsOpened, _onLaunchedWithItems, _eventNames2, _lastBroadcastValue, _overlayActive, _overlayTimer, _UI_instances, postMessageWithCallback_fn, postMessageAsync_fn, postMessageWithObject_fn, ipc_stub_fn, _showTime, _hideTimeout, removeSpinner_fn;
var UI = class extends EventListener {
  constructor(puter3, { appInstanceID, parentInstanceID }) {
    ...
    super(eventNames);
    __privateAdd(this, _UI_instances);
    // Used to generate a unique message id for each message sent to the host environment
    // we start from 1 because 0 is falsy and we want to avoid that for the message id
    __privateAdd(this, _messageID3, 1);
    ...
    __privateAdd(this, _parentAppConnection, null);
    // Holds the callback functions for the various events
    // that can be triggered by the host environment's messages.
    __privateAdd(this, _callbackFunctions, []);
    ...
    __privateAdd(this, _onWindowClose);
    // When an item is opened by this app in any way onItemsOpened() is executed. Users can override this function.
    __privateAdd(this, _onItemsOpened);
    __privateAdd(this, _onLaunchedWithItems);
    // List of events that can be listened to.
    __privateAdd(this, _eventNames2);
    // The most recent value that we received for a given broadcast, by name.
    __privateAdd(this, _lastBroadcastValue, /* @__PURE__ */ new Map());
    // name -> data
    __privateAdd(this, _overlayActive, false);
    __privateAdd(this, _overlayTimer, null);
    /**
     ...
     */
    __publicField(this, "getEntriesFromDataTransferItems", async function(dataTransferItems, options = { raw: false }) {
      const checkErr = (err) => {
...
Try serving html over http if currently you are running it from the filesystem.`;
     ...
     * @returns
     */
    __publicField(this, "launchApp", async function launchApp(nameOrOptions, args, callback) {
      ...
      const app_info = await __privateMethod(this, _UI_instances, ipc_stub_fn).call(this, {
        method: "launchApp",
        callback,
        parameters: {
          app_name,
    ...
    __publicField(this, "connectToInstance", async function connectToInstance(app_name) {
      const app_info = await __privateMethod(this, _UI_instances, ipc_stub_fn).call(this, {
    ...
    __privateAdd(this, _showTime, null);
    __privateAdd(this, _hideTimeout, null);
    __privateSet(this, _eventNames2, eventNames);
    this.puter = puter3;
    this.appInstanceID = appInstanceID;
    ...
    if (this.parentInstanceID) {
      __privateSet(this, _parentAppConnection, new AppConnection(this.puter, {
    ...
    (_a = this.messageTarget) == null ? void 0 : _a.postMessage({
      msg: "READY",
      appInstanceID: this.appInstanceID
    }, "*");
    globalThis.document && window.addEventListener("focus", (e2) => {
      var _a2;
      (_a2 = this.messageTarget) == null ? void 0 : _a2.postMessage({
        msg: "windowFocused",
        appInstanceID: this.appInstanceID
      }, "*");
    });
    ...
    globalThis.document && window.addEventListener("message", async (e2) => {
      ...
      if (e2.data.error) {
        ...
        if (__privateGet(this, _onWindowClose) === void 0) {
          (_a2 = this.messageTarget) == null ? void 0 : _a2.postMessage({
            msg: true,
            appInstanceID: this.appInstanceID,
          ...
          (_b2 = this.messageTarget) == null ? void 0 : _b2.postMessage({
            msg: false,
            appInstanceID: this.appInstanceID,
            original_msg_id: e2.data.msg_id
          }, "*");
          __privateGet(this, _onWindowClose).call(this);
        }
      } else if (e2.data.msg === "itemsOpened") {
        if (__privateGet(this, _onItemsOpened) === void 0) {
          (_c2 = this.messageTarget) == null ? void 0 : _c2.postMessage({
            msg: true,
            appInstanceID: this.appInstanceID,
            original_msg_id: e2.data.msg_id
          }, "*");
        } else {
          (_d = this.messageTarget) == null ? void 0 : _d.postMessage({
            msg: false,
            appInstanceID: this.appInstanceID,
            original_msg_id: e2.data.msg_id
          }, "*");
          ...
          __privateGet(this, _onItemsOpened).call(this, items);
        }
      } else if (e2.data.msg === "getAppDataSucceeded") {
        let appDataItem = new FSItem_default(e2.data.item);
        if (e2.data.original_msg_id && __privateGet(this, _callbackFunctions)[e2.data.original_msg_id]) {
          __privateGet(this, _callbackFunctions)[e2.data.original_msg_id](appDataItem);
        }
      } else if (e2.data.msg === "instancesOpenSucceeded") {
        if (e2.data.original_msg_id && __privateGet(this, _callbackFunctions)[e2.data.original_msg_id]) {
          __privateGet(this, _callbackFunctions)[e2.data.original_msg_id](e2.data.instancesOpen);
        }
        ...
        if (e2.data.original_msg_id && __privateGet(this, _callbackFunctions)[e2.data.original_msg_id]) {
          __privateGet(this, _callbackFunctions)[e2.data.original_msg_id](null);
        }
      } else if (e2.data.original_msg_id !== void 0 && __privateGet(this, _callbackFunctions)[e2.data.original_msg_id]) {
        if (e2.data.msg === "fileOpenPicked") {
          if (e2.data.items.length === 1) {
            __privateGet(this, _callbackFunctions)[e2.data.original_msg_id](new FSItem_default(e2.data.items[0]));
          } else if (e2.data.items.length > 1) {
            let items = [];
            for (let index = 0; index < e2.data.items.length; index++) {
              items.push(new FSItem_default(e2.data.items[index]));
            }
            __privateGet(this, _callbackFunctions)[e2.data.original_msg_id](items);
          }
        } else if (e2.data.msg === "directoryPicked") {
          if (e2.data.items.length === 1) {
            __privateGet(this, _callbackFunctions)[e2.data.original_msg_id](new FSItem_default({
          ...
          __privateGet(this, _callbackFunctions)[e2.data.original_msg_id](e2.data.color);
        } else if (e2.data.msg === "fontPicked") {
          __privateGet(this, _callbackFunctions)[e2.data.original_msg_id](e2.data.font);
        } else if (e2.data.msg === "alertResponded") {
          __privateGet(this, _callbackFunctions)[e2.data.original_msg_id](e2.data.response);
        } else if (e2.data.msg === "promptResponded") {
          __privateGet(this, _callbackFunctions)[e2.data.original_msg_id](e2.data.response);
        } else if (e2.data.msg === "notificationShown") {
          __privateGet(this, _callbackFunctions)[e2.data.original_msg_id](e2.data.uid);
        } else if (e2.data.msg === "languageReceived") {
          __privateGet(this, _callbackFunctions)[e2.data.original_msg_id](e2.data.language);
        } else if (e2.data.msg === "fileSaved") {
          __privateGet(this, _callbackFunctions)[e2.data.original_msg_id](new FSItem_default(e2.data.saved_file));
        } else if (e2.data.msg === "fileSaveCancelled") {
          __privateGet(this, _callbackFunctions)[e2.data.original_msg_id](FILE_SAVE_CANCELLED);
        } else if (e2.data.msg === "fileOpenCancelled") {
          __privateGet(this, _callbackFunctions)[e2.data.original_msg_id](FILE_OPEN_CANCELLED);
        } else {
          __privateGet(this, _callbackFunctions)[e2.data.original_msg_id](e2.data);
        }
        delete __privateGet(this, _callbackFunctions)[e2.data.original_msg_id];
        ...
        if (!__privateGet(this, _eventNames2).includes(name)) {
          return;
        }
        this.emit(name, data);
        __privateGet(this, _lastBroadcastValue).set(name, data);
        ...
        const accept = (value) => {
          var _a3;
          (_a3 = this.messageTarget) == null ? void 0 : _a3.postMessage({
            $: "connection-resp",
    ...
    (_b = globalThis.document) == null ? void 0 : _b.addEventListener("mousemove", async (event) => {
      var _a2;
    ...
    (_c = globalThis.document) == null ? void 0 : _c.addEventListener("click", async (event) => {
      var _a2;
      this.mouseX = event.clientX;
      this.mouseY = event.clientY;
      (_a2 = this.messageTarget) == null ? void 0 : _a2.postMessage({
  ...
  onWindowClose(callback) {
    __privateSet(this, _onWindowClose, callback);
  }
  onItemsOpened(callback) {
    if (!__privateGet(this, _onItemsOpened)) {
    ...
    __privateSet(this, _onItemsOpened, callback);
  }
  ...
  onLaunchedWithItems(callback) {
    if (!__privateGet(this, _onLaunchedWithItems)) {
      let URLParams = new URLSearchParams(globalThis.location.search);
      if (URLParams.has("puter.item.name") && URLParams.has("puter.item.uid") && URLParams.has("puter.item.read_url")) {
        let fpath = URLParams.get("puter.item.path");
        if (!fpath.startsWith("~/") && !fpath.startsWith("/")) {
    ...
    __privateSet(this, _onLaunchedWithItems, callback);
  }
  requestEmailConfirmation() {
    return new Promise((resolve, reject) => {
      __privateMethod(this, _UI_instances, postMessageWithCallback_fn).call(this, "requestEmailConfirmation", resolve, {});
    });
  }
  alert(message, buttons, options, callback) {
    return new Promise((resolve) => {
      __privateMethod(this, _UI_instances, postMessageWithCallback_fn).call(this, "ALERT", resolve, { message, buttons, options });
    });
  }
  openDevPaymentsAccount() {
    return new Promise((resolve) => {
      __privateMethod(this, _UI_instances, postMessageWithCallback_fn).call(this, "openDevPaymentsAccount", resolve, {});
    });
  }
  instancesOpen(callback) {
    return new Promise((resolve) => {
      __privateMethod(this, _UI_instances, postMessageWithCallback_fn).call(this, "getInstancesOpen", resolve, {});
    });
  }
  socialShare(url, message, options, callback) {
    return new Promise((resolve) => {
      __privateMethod(this, _UI_instances, postMessageWithCallback_fn).call(this, "socialShare", resolve, { url, message, options });
    });
  }
  prompt(message, placeholder, options, callback) {
    return new Promise((resolve) => {
      __privateMethod(this, _UI_instances, postMessageWithCallback_fn).call(this, "PROMPT", resolve, { message, placeholder, options });
    });
  }
  notify(options) {
    return new Promise((resolve) => {
      ...
      __privateMethod(this, _UI_instances, postMessageWithCallback_fn).call(this, "showNotification", resolve, { options: normalized });
    });
  }
  showDirectoryPicker(options, callback) {
    return new Promise((resolve, reject) => {
      ...
      const msg_id = __privateWrapper(this, _messageID3)._++;
      if (this.env === "app") {
        (_a = this.messageTarget) == null ? void 0 : _a.postMessage({
      ...
      __privateGet(this, _callbackFunctions)[msg_id] = resolve;
    });
  }
  showOpenFilePicker(options, callback) {
    ...
    const resolveOnlyPromise = new Promise((resolve, reject) => {
      ...
      __privateGet(this, _callbackFunctions)[msg_id] = (maybe_result) => {
  ...
  showFontPicker(options) {
    return new Promise((resolve) => {
      __privateMethod(this, _UI_instances, postMessageWithCallback_fn).call(this, "showFontPicker", resolve, { options: options ?? {} });
    });
  }
  showColorPicker(options) {
    return new Promise((resolve) => {
      __privateMethod(this, _UI_instances, postMessageWithCallback_fn).call(this, "showColorPicker", resolve, { options: options ?? {} });
    });
  }
  requestUpgrade() {
    return new Promise((resolve) => {
      __privateMethod(this, _UI_instances, postMessageWithCallback_fn).call(this, "requestUpgrade", resolve, {});
    });
  }
    ...
    const resolveOnlyPromise = new Promise((resolve, reject) => {
      ...
      if (this.env === "app") {
        ...
        window.addEventListener("message", async (e2) => {
          var _a2;
          if (((_a2 = e2.data) == null ? void 0 : _a2.msg) === "sendMeFileData") {
  ...
  setWindowTitle(title, window_id, callback) {
    ...
    return new Promise((resolve) => {
      __privateMethod(this, _UI_instances, postMessageWithCallback_fn).call(this, "setWindowTitle", resolve, { new_title: title, window_id });
    });
  }
  setWindowWidth(width, window_id, callback) {
    ...
    return new Promise((resolve) => {
      __privateMethod(this, _UI_instances, postMessageWithCallback_fn).call(this, "setWindowWidth", resolve, { width, window_id });
    });
  }
  setWindowHeight(height, window_id, callback) {
    ...
    return new Promise((resolve) => {
      __privateMethod(this, _UI_instances, postMessageWithCallback_fn).call(this, "setWindowHeight", resolve, { height, window_id });
    });
  }
  setWindowSize(width, height, window_id, callback) {
    ...
    return new Promise((resolve) => {
      __privateMethod(this, _UI_instances, postMessageWithCallback_fn).call(this, "setWindowSize", resolve, { width, height, window_id });
    });
  }
  setWindowPosition(x2, y2, window_id, callback) {
    ...
    return new Promise((resolve) => {
      __privateMethod(this, _UI_instances, postMessageWithCallback_fn).call(this, "setWindowPosition", resolve, { x: x2, y: y2, window_id });
    });
  }
  setWindowY(y2, window_id, callback) {
    ...
    return new Promise((resolve) => {
      __privateMethod(this, _UI_instances, postMessageWithCallback_fn).call(this, "setWindowY", resolve, { y: y2, window_id });
    });
  }
  setWindowX(x2, window_id, callback) {
    ...
    return new Promise((resolve) => {
      __privateMethod(this, _UI_instances, postMessageWithCallback_fn).call(this, "setWindowX", resolve, { x: x2, window_id });
    });
  }
  showWindow() {
    __privateMethod(this, _UI_instances, postMessageWithObject_fn).call(this, "showWindow");
  }
  hideWindow() {
    __privateMethod(this, _UI_instances, postMessageWithObject_fn).call(this, "hideWindow");
  }
  toggleWindow() {
    __privateMethod(this, _UI_instances, postMessageWithObject_fn).call(this, "toggleWindow");
  }
  setMenubar(spec) {
    __privateMethod(this, _UI_instances, postMessageWithObject_fn).call(this, "setMenubar", spec);
  }
  async requestPermission(options) {
    if (this.env === "app") {
      const result = await __privateMethod(this, _UI_instances, postMessageAsync_fn).call(this, "requestPermission", { options });
  ...
  disableMenuItem(item_id) {
    __privateMethod(this, _UI_instances, postMessageWithObject_fn).call(this, "disableMenuItem", { id: item_id });
  }
  enableMenuItem(item_id) {
    __privateMethod(this, _UI_instances, postMessageWithObject_fn).call(this, "enableMenuItem", { id: item_id });
  }
  setMenuItemIcon(item_id, icon) {
    __privateMethod(this, _UI_instances, postMessageWithObject_fn).call(this, "setMenuItemIcon", { id: item_id, icon });
  }
  setMenuItemIconActive(item_id, icon) {
    __privateMethod(this, _UI_instances, postMessageWithObject_fn).call(this, "setMenuItemIconActive", { id: item_id, icon });
  }
  setMenuItemChecked(item_id, checked) {
    __privateMethod(this, _UI_instances, postMessageWithObject_fn).call(this, "setMenuItemChecked", { id: item_id, checked });
  }
  contextMenu(spec) {
    __privateMethod(this, _UI_instances, postMessageWithObject_fn).call(this, "contextMenu", spec);
  }
  ...
  parentApp() {
    return __privateGet(this, _parentAppConnection);
  }
  createWindow(options, callback) {
    return new Promise((resolve) => {
      __privateMethod(this, _UI_instances, postMessageWithCallback_fn).call(this, "createWindow", (res) => {
        resolve(res.window);
      }, { options: options ?? {} });
    });
  }
  ...
  on(eventName, callback) {
    ...
    if (__privateGet(this, _eventNames2).includes(eventName) && __privateGet(this, _lastBroadcastValue).has(eventName)) {
      callback(__privateGet(this, _lastBroadcastValue).get(eventName));
    }
  }
  showSpinner(html) {
    if (__privateGet(this, _overlayActive)) return;
    ...
    __privateSet(this, _overlayActive, true);
    __privateSet(this, _showTime, Date.now());
    __privateSet(this, _overlayTimer, setTimeout(() => {
      __privateSet(this, _overlayTimer, null);
    }, 1e3));
  }
  hideSpinner() {
    if (!__privateGet(this, _overlayActive)) return;
    if (__privateGet(this, _overlayTimer)) {
      clearTimeout(__privateGet(this, _overlayTimer));
      __privateSet(this, _overlayTimer, null);
    }
    const elapsedTime = Date.now() - __privateGet(this, _showTime);
    ...
    if (remainingTime > 0) {
      ...
      __privateSet(this, _hideTimeout, setTimeout(() => {
        __privateMethod(this, _UI_instances, removeSpinner_fn).call(this);
      }, remainingTime));
    } else {
      __privateMethod(this, _UI_instances, removeSpinner_fn).call(this);
    }
  ...
  isWorkingActive() {
    return __privateGet(this, _overlayActive);
  }
  /**
  ...
  getLanguage() {
    ...
    return new Promise((resolve) => {
      __privateMethod(this, _UI_instances, postMessageWithCallback_fn).call(this, "getLanguage", resolve, {});
    });
  }
};
_messageID3 = new WeakMap();
_parentAppConnection = new WeakMap();
_callbackFunctions = new WeakMap();
_onWindowClose = new WeakMap();
_onItemsOpened = new WeakMap();
_onLaunchedWithItems = new WeakMap();
_eventNames2 = new WeakMap();
_lastBroadcastValue = new WeakMap();
_overlayActive = new WeakMap();
_overlayTimer = new WeakMap();
_UI_instances = new WeakSet();
// Replaces boilerplate for most methods: posts a message to the GUI with a unique ID, and sets a callback for it.
postMessageWithCallback_fn = function(name, resolve, args = {}) {
  var _a;
  const msg_id = __privateWrapper(this, _messageID3)._++;
  (_a = this.messageTarget) == null ? void 0 : _a.postMessage({
    msg: name,
  ...
  __privateGet(this, _callbackFunctions)[msg_id] = (...a2) => {
    resolve(...a2);
  };
};
postMessageAsync_fn = function(name, args = {}) {
  return new Promise((resolve) => {
    __privateMethod(this, _UI_instances, postMessageWithCallback_fn).call(this, name, resolve, args);
  });
};
postMessageWithObject_fn = function(name, value) {
  var _a;
...
var WorkersHandler = class {
  ...
  async create(workerName, filePath, appName) {
    ...
    if (typeof appName === "object" || typeof appName === "undefined") {
      ...
      if (user.is_user_token && (appName === void 0 || (appName == null ? void 0 : appName.sandbox) !== false)) {
        let sandboxApp;
        try {
    ...
    if (!driverResult.success) {
      throw new Error((driverResult == null ? void 0 : driverResult.errors) || "Driver failed to execute, do you have the necessary permissions?");
    }
...
var puterInit = function() {
  "use strict";
  var _defaultAPIOrigin, _defaultGUIOrigin;
  class Puter {
    // --------------------------------------------
    // Constructor
    // --------------------------------------------
    constructor() {
      ...
      __privateAdd(this, _defaultAPIOrigin, "https://api.puter.com");
      __privateAdd(this, _defaultGUIOrigin, "https://puter.com");
       ...
       */
      __publicField(this, "puterAuthState", {
        isPromptOpen: false,
        authGranted: null,
        resolver: null
      });
       ...
       */
      __publicField(this, "initSubmodules", function() {
        this.util = new Util();
      ...
      __publicField(this, "setAppID", function(appID) {
        try {
      ...
      __publicField(this, "setAuthToken", function(authToken) {
        this.authToken = authToken;
      ...
      __publicField(this, "setAPIOrigin", function(APIOrigin) {
        this.APIOrigin = APIOrigin;
        this.updateSubmodules();
      });
      __publicField(this, "runWhenPuterHappensCallbacks", function() {
      ...
      __publicField(this, "resetAuthToken", function() {
      ...
      __publicField(this, "exit", function(statusCode = 0) {
       ...
       *
       */
      __publicField(this, "randName", function(separateWith = "-") {
        const first_adj = [
          "helpful",
          "sensible",
          "loyal",
      ...
      __publicField(this, "print", function(...args) {
        let options = {};
       ...
       * @param {boolean} config.enabled - Enable/disable API call logging
        * @param {boolean} config.enabled - Enable/disable API call logging
       */
      __publicField(this, "configureAPILogging", function(config = {}) {
       ...
       */
      __publicField(this, "enableAPILogging", function(config = {}) {
        if (this.apiCallLogger) {
       ...
       * Disables API call logging
       */
      __publicField(this, "disableAPILogging", function() {
        if (this.apiCallLogger) {
       ...
       * @private
       */
      __publicField(this, "initNetworkMonitoring", function() {
       ...
       * @private
       */
      __publicField(this, "checkAndUpdateGUIFScache", function() {
      ...
      this.modules_ = [];
      let URLParams = new URLSearchParams((_a = globalThis.location) == null ? void 0 : _a.search);
      const normalizeAuthTokenCandidate = (tokenCandidate) => {
        ...
        if (!trimmedTokenCandidate || trimmedTokenCandidate === "null" || trimmedTokenCandidate === "undefined") {
          return null;
        }
      ...
      if (this.env === "gui") {
        ...
        try {
          if (bootstrapAuthToken) {
            ...
            if (((_b = globalThis.history) == null ? void 0 : _b.replaceState) && ((_c = globalThis.location) == null ? void 0 : _c.href)) {
              const currentUrl = new URL(globalThis.location.href);
              const hadBootstrapToken = currentUrl.searchParams.has("puter.auth.token") || currentUrl.searchParams.has("auth_token");
      ...
      (async () => {
        try {
          ...
          const prefix = `[${(whoami == null ? void 0 : whoami.app_name) ?? this.appInstanceID ?? "HOST"}]`;
    ...
    get defaultAPIOrigin() {
      return globalThis.PUTER_API_ORIGIN || globalThis.PUTER_API_ORIGIN_ENV || __privateGet(this, _defaultAPIOrigin);
    }
    set defaultAPIOrigin(v2) {
      __privateSet(this, _defaultAPIOrigin, v2);
    }
    get defaultGUIOrigin() {
      return globalThis.PUTER_ORIGIN || globalThis.PUTER_ORIGIN_ENV || __privateGet(this, _defaultGUIOrigin);
    }
    set defaultGUIOrigin(v2) {
      __privateSet(this, _defaultGUIOrigin, v2);
    }
    /**
     * @internal
    ...
    updateSubmodules() {
      ...
      for (const name of this.modules_) {
        ...
        (_b = (_a = this[name]) == null ? void 0 : _a.setAuthToken) == null ? void 0 : _b.call(_a, this.authToken);
        (_d = (_c = this[name]) == null ? void 0 : _c.setAPIOrigin) == null ? void 0 : _d.call(_c, this.APIOrigin);
      }
    }
  }
  _defaultAPIOrigin = new WeakMap();
  _defaultGUIOrigin = new WeakMap();
  // Expose the FSItem class
  __publicField(Puter, "FSItem", FSItem_default);
...
@heyputer/puter.js/src/lib/socket.io/socket.io.esm.min.js:
  (*!
   * Socket.IO v4.7.2
